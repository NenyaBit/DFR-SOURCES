scriptname dbrecurringquestscript extends quest conditional
...
referencealias property nightmotheralias  auto  
...
int property contact  auto conditional
int property target  auto conditional  
int property havecontract  auto conditional  
